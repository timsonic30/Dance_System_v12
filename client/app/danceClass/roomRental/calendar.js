    ...
    <div>
      ...
      <div className="flex justify-center mb-6">
        <button
          ...
          className={`px-4 py-2 mr-4 border rounded-md transition-all ${selectedRoom === "Room X" ? "bg-primary text-primary-foreground" : "bg-background"
        ...
        <button
          ...
          className={`px-4 py-2 mr-4 border rounded-md transition-all ${selectedRoom === "Room L" ? "bg-primary text-primary-foreground" : "bg-background"
            } hover:bg-secondary hover:text-secondary-foreground hover:scale-105`}
        >
          Room L
        </button>
        <button
          ...
          className={`px-4 py-2 border rounded-md transition-all ${selectedRoom === "Room XL" ? "bg-primary text-primary-foreground" : "bg-background"
            } hover:bg-secondary hover:text-secondary-foreground hover:scale-105`}
        >
          Room XL
        </button>
